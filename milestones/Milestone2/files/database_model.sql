...
CREATE TABLE IF NOT EXISTS `Hotel` (
  ...
  `poolId` INT NOT NULL,
  PRIMARY KEY (`hotelId`),
  INDEX `fk_Hotel_Owner1_idx` (`ownerId` ASC) VISIBLE,
  INDEX `fk_Hotel_Revenue1_idx` (`revenueId` ASC) VISIBLE,
  INDEX `fk_Hotel_Power Generator1_idx` (`generatorId` ASC) VISIBLE,
  INDEX `fk_Hotel_Fire Alarm1_idx` (`fAlarmId` ASC) VISIBLE,
  INDEX `fk_Hotel_Security Alarm1_idx` (`securityId` ASC) VISIBLE,
  UNIQUE INDEX `addressId_UNIQUE` (`addressId` ASC) VISIBLE,
  UNIQUE INDEX `revenueId_UNIQUE` (`revenueId` ASC) VISIBLE,
  INDEX `fk_Hotel_Pool1_idx` (`poolId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Expenditures` (
  ...
  INDEX `fk_Expenditures_Hotel1_idx` (`hotelId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Fire Department` (
  ...
  INDEX `fk_Fire Department_Fire Alarm1_idx` (`fAlarmId` ASC) VISIBLE,
  UNIQUE INDEX `fAlarmId_UNIQUE` (`fAlarmId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Police Station` (
  ...
  INDEX `fk_Police Station_Security Alarm1_idx` (`securtiyId` ASC) VISIBLE,
  UNIQUE INDEX `securtiyId_UNIQUE` (`securtiyId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Room` (
  ...
  INDEX `fk_Room_Booking1_idx` (`bookingId` ASC) VISIBLE,
  UNIQUE INDEX `Booking_bookingId_UNIQUE` (`bookingId` ASC) VISIBLE,
  INDEX `fk_Room_Room Class1_idx` (`classId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Register` (
  ...
  INDEX `fk_Register_Payment1_idx` (`paymentId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Item` (
  ...
  INDEX `fk_Item_Register1_idx` (`registerId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Customer` (
  ...
  INDEX `fk_Customer_Booking1_idx` (`bookingId` ASC) VISIBLE,
  INDEX `fk_Customer_Invoice1_idx` (`invoiceId` ASC) VISIBLE,
  INDEX `fk_Customer_Payment1_idx` (`paymentId` ASC) VISIBLE,
  UNIQUE INDEX `invoiceId_UNIQUE` (`invoiceId` ASC) VISIBLE,
  UNIQUE INDEX `paymentId_UNIQUE` (`paymentId` ASC) VISIBLE,
  INDEX `fk_Customer_Hotel1_idx` (`hotelId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `FoodMade` (
  ...
  INDEX `fk_Restaurant Employee_has_Food_Food1_idx` (`foodId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `EmployeesManaged` (
  ...
  INDEX `fk_Manages_House Keeping Employee1_idx` (`houseKeepingId` ASC) VISIBLE,
  INDEX `fk_Manages_Restaurant Employee1_idx` (`restaurantId` ASC) VISIBLE,
  INDEX `fk_Manages_Front Desk Employee1_idx` (`deskId` ASC) VISIBLE,
  UNIQUE INDEX `House Keeping Employee_employeeId_UNIQUE` (`houseKeepingId` ASC) VISIBLE,
  UNIQUE INDEX `Restaurant Employee_employeeId_UNIQUE` (`restaurantId` ASC) VISIBLE,
  UNIQUE INDEX `Front Desk Employee_employeeId_UNIQUE` (`deskId` ASC) VISIBLE,
